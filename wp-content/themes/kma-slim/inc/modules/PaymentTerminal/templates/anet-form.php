...
include(wp_normalize_path($moduleDir . '/includes/functions.php'));
require(wp_normalize_path($moduleDir . '/authorize/config.php')); //important file. Don't forget to edit it!

$anpt_display_comment  = isset($_GET['comment']) && $_GET['comment'] == 'true' ? 1 : 2;
$anpt_show_amount_text = isset($_GET['serv']) ? $_GET['serv'] : 1;
...
$show_services = isset($_GET['serv']) && $_GET['serv'] == 'true' ? 1 : 0;
            ...
            <div class="column is-narrow">
                ...
                <div class="control">
                    ...
                    <optgroup label="Australian Provinces">
                        ...
                        <option value="-AU-ACT" <?php echo $state == "-AU-ACT" ? "selected" : "" ?>>Australian Capital
                            Territory
                        </option>
