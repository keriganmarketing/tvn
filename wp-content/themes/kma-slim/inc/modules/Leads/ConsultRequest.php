...
class ConsultRequest extends Leads
{
    ...
    protected function sendNotifications ($leadInfo)
    {
        ...
        $patientIntro  = '<p>Thank you for requesting a virtual consultation with Dr. Rifai.</p><h1>Next Steps:</h1><p>Please download the <a href="https://thevirtualnephrologist.com/wp-content/uploads/2021/07/TVN-New-Patient-Packet-Complete.pdf">New Patient Packet pdf file</a>. Once downloaded, please fill out the information as complete as possible and fax to (850)914-3004. Be sure to keep your copies safe for use as a reference/record.</P> <h1>What To Expect:</h1><p>Once we receive your medical records via fax, we will review the information you have provided and contact you to schedule a consultation at a time convenient for you.</p><p>The information you provided to us is:</p>';
